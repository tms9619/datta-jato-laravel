...
<html lang="pt-br">
	...
	<body>
		...
		<header>
			...
			<nav class="navbar navbar-expand-md navbar-dark sticky-top bg-primary">
				...
				<div class="container">
					...
					<!-- Logo -->
					<a class="navbar-brand" href="{{ route('user_cliente.index')}}">
						DattaJato
					</a>
						...
						<ul class="navbar-nav ms-auto">
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<a class="dropdown-item" href="{{ route('user_cliente.index')}}">Novo</a>
								</div>
							</li>
                            <li class="nav-item">
		...
		<!-- Início section agendamentos-realizados-->
		<section id="agendamentos-realizados">
			...
			<div class="container">
				...
				<div class="row mt-5">
					...
					<div class="col-12">
						...
						<h1 class="display-4">Agendamentos <span class="lead">(Realizados)</span></h1>
						<hr>
